...
$dlrm_pt_bin --num-workers=64 --arch-sparse-feature-size=16 --arch-mlp-bot="13-512-256-64-16" --arch-mlp-top="512-256-1" --data-generation=dataset --data-set=kaggle --raw-data-file=./input/train.txt --processed-data-file=./input/kaggleAdDisplayChallenge_processed.npz --loss-function=bce --round-targets=True --learning-rate=0.1 --mini-batch-size=1024 --print-freq=1024 --print-time --test-mini-batch-size=16384 --test-num-workers=64 $dlrm_extra_option 2>&1 | tee run_kaggle_pt.log
